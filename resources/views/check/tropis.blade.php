...
<head>
    ...
    <title>Villa Tropis | Luxe Stay</title>
...
<body class="bg-[#F5F1EF] text-gray-900">
    ...
    <div class="px-12 flex justify-between items-start">
        <div>
            <h2 class="text-5xl font-bold text-blue-900">Villa Tropis</h2>
    ...
    <section class="px-12 mt-6 grid grid-cols-12 gap-6">
        <div class="col-span-6">
            <img src="{{asset('/image/Rectangle 1095 (1).png')}}"
                 class="rounded-xl h-80 w-full object-cover shadow-lg">
        </div>
        <div class="col-span-6 grid grid-cols-2 gap-4">
            <img src="{{asset('/image/villa2-1.png')}}" class="rounded-xl h-36 object-cover shadow">
            <img src="{{asset('/image/villa2-2.png')}}" class="rounded-xl h-36 object-cover shadow">
            <img src="{{asset('/image/villa2-3.png')}}" class="rounded-xl h-36 object-cover shadow">
            <img src="{{asset('/image/villa2-4.png')}}" class="rounded-xl h-36 object-cover shadow">
        </div>
    </section>
    ...
    <section class="px-12 mt-6">
        <div class="border border-gray-400 rounded-lg p-5">
            ...
            <div class="flex gap-10 text-sm mb-5 justify-center">
                ...
                <div class="flex flex-col items-center"><i class="fa-solid fa-swimming-pool text-xl"></i><span>Private Pool</span></div>
                <div class="flex flex-col items-center"><i class="fa-solid fa-tree text-xl"></i><span>Tropical Garden</span></div>
                <div class="flex flex-col items-center"><i class="fa-solid fa-utensils text-xl"></i><span>BBQ Area</span></div>
            </div>
    ...
    <section class="px-12 mt-8 max-w-xl">
        ...
        <p class="text-sm text-gray-700 leading-relaxed">
            Villa Tropis hadir dengan suasana tropis alami untuk liburan penuh ketenangan.
            Didesain dengan interior kayu natural dan pemandangan alam sekitar yang memanjakan mata.
        </p>
    </section>
