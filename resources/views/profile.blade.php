...
<body class="bg-[#0F2244] min-h-screen">
    ...
    <header class="w-full bg-[#0F2244] py-4 px-10 flex items-center justify-between">
        ...
        <div class="bg-[#E8C784] px-6 py-4 rounded-br-2xl">
            <h1 class="text-3xl font-serif text-[#0F2244] tracking-wide">LUXE<br><span class="text-sm">STAY</span></h1>
        </div>
    ...
    <button class="peer p-2 rounded-full hover:bg-white/10 transition">
        <svg xmlns="http://www.w3.org/2000/svg" class="w-8 h-8 text-white" fill="none"
            ...
            <path stroke-linecap="round" stroke-linejoin="round"
                d="M12 12c2.761 0 5-2.239 5-5s-2.239-5-5-5-5 2.239-5 5 2.239 5 5 5zm0 2c-3.86 0-7 3.141-7 7h2c0-2.757
                2.243-5 5-5s5 2.243 5 5h2c0-3.859-3.14-7-7-7z" />
        </svg>
    </button>

    <!-- DROPDOWN -->
    <div
        class="hidden peer-focus:flex peer-hover:flex hover:flex
    ...
    <section class="px-10 py-10 grid grid-cols-1 lg:grid-cols-2 gap-10">
        ...
        <div class="bg-[#2C3E5E] rounded-2xl p-10 text-white">
            ...
            <div class="space-y-5">
                ...
                <!-- Button -->
                <button class="w-full bg-[#5C6EF8] py-2 rounded-lg text-white font-semibold flex justify-center items-center space-x-2">
        ...
        <div class="bg-[#2C3E5E] rounded-2xl p-10 text-white flex flex-col items-center justify-center">
            ...
            <!-- Icon User -->
            <div class="bg-white rounded-full w-40 h-40 flex items-center justify-center mb-4">
                <svg xmlns="http://www.w3.org/2000/svg" class="w-24 h-24 text-gray-700" fill="currentColor"
                    viewBox="0 0 24 24">
                    <path
                        d="M12 12c2.761 0 5-2.239 5-5s-2.239-5-5-5-5 2.239-5 5 2.239 5 5 5zm0 2c-3.86 0-7 3.141-7 7h2c0-2.757 2.243-5 5-5s5 2.243 5 5h2c0-3.859-3.14-7-7-7z" />
                </svg>
            </div>
