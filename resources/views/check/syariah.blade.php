...
<head>
    ...
    <title>Apartemen Syariah | Luxe Stay</title>
...
<div class="px-12 flex justify-between items-start">
    <div>
        <h2 class="text-5xl font-bold text-blue-900">Apartemen Syariah</h2>
        <div class="text-yellow-500 mt-2 text-lg">★★★★☆</div>
    </div>

    <a href="#booking" class="bg-[#D8C07A] text-white px-6 py-3 rounded-lg font-semibold shadow hover:opacity-90 transition">BOOK NOW</a>
</div>

<!-- Gallery -->
<section class="px-12 mt-6 grid grid-cols-12 gap-6">
    <div class="col-span-6">
        <img src="{{asset('/image/Rectangle 1095 (2).png')}}" class="rounded-xl h-80 w-full object-cover shadow-lg">
    </div>
    <div class="col-span-6 grid grid-cols-2 gap-4">
        <img src="{{asset('/image/apsy1.png')}}" class="rounded-xl h-36 object-cover shadow">
        <img src="{{asset('/image/apsy2.png')}}" class="rounded-xl h-36 object-cover shadow">
        <img src="{{asset('/image/apsy3.png')}}" class="rounded-xl h-36 object-cover shadow">
        <img src="{{asset('/image/apsy4.png')}}" class="rounded-xl h-36 object-cover shadow">
    </div>
</section>
...
<section class="px-12 mt-6">
    <div class="border border-gray-400 rounded-lg p-5">
        ...
        <div class="flex gap-10 text-sm mb-5 justify-center">
            ...
            <div class="flex flex-col items-center"><i class="fa-solid fa-mosque text-xl"></i><span>Syariah Friendly</span></div>
            <div class="flex flex-col items-center"><i class="fa-solid fa-utensils text-xl"></i><span>Restaurant</span></div>
            <div class="flex flex-col items-center"><i class="fa-solid fa-person-swimming text-xl"></i><span>Pool</span></div>
        </div>
...
<section class="px-12 mt-8 max-w-xl">
    ...
    <p class="text-sm text-gray-700 leading-relaxed">
        Apartemen Syariah hadir sebagai hunian modern yang mengedepankan kenyamanan sesuai prinsip Islam untuk keluarga.
    </p>
</section>
